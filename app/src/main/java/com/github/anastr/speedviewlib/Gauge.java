...
public abstract class Gauge extends View {
    ...
    protected String getSpeedText() {
        return speedTextFormat == FLOAT_FORMAT ? String.format(locale, "%.2f", currentSpeed)
    ...
    protected String getMaxSpeedText() {
        return tickTextFormat == FLOAT_FORMAT ? String.format(locale, "%.2f", maxSpeed)
    ...
    protected String getMinSpeedText() {
        return tickTextFormat == FLOAT_FORMAT ? String.format(locale, "%.2f", minSpeed)
